...
public class Create_Campaign_PromoCode extends CampaignDetailsPage {
    ...
    @Test
    public void CreateCampaignWithPromoCode() throws InterruptedException {
        campaign_creation_details.setCampaignDescription(5);
