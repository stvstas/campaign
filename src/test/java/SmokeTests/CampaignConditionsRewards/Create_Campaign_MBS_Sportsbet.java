...
public class Create_Campaign_MBS_Sportsbet {
    ...
    @Test
    public void CreateCampaignWithSportsbetCondition() throws InterruptedException {
        campaign_creation_details.setCampaignDescription(2);
