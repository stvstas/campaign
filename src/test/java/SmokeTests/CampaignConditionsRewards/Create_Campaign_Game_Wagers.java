...
public class Create_Campaign_Game_Wagers {
    ...
    @Test@Ignore
    public void CreateCampaignWithGameWagers() throws InterruptedException {
        ...
        campaign_creation_conditions.gameWagersCondition();
